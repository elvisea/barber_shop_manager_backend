...
/**
 * Documentação completa do endpoint de criação de membro de estabelecimento
 *
 * Este decorator composto aplica toda a documentação Swagger necessária
 * para o endpoint POST /establishments/:establishmentId/members
 */
export function CreateUserEstablishmentDocs() {
  return applyDecorators(
    ApiOperation({
      summary: 'Create a new establishment member',
      description:
        'Cria um novo membro (usuário) para o estabelecimento. Cria um novo User e vincula ao estabelecimento através de UserEstablishment.',
    }),
