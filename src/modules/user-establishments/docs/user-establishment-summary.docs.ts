...
/**
 * Documentação completa do endpoint de resumo de membro de estabelecimento
 *
 * Este decorator composto aplica toda a documentação Swagger necessária
 * para o endpoint GET /members/:memberId/summary
 */
export function UserEstablishmentSummaryDocs() {
  return applyDecorators(
    ApiOperation({
      summary: 'Get establishment member summary with relationships',
      description:
